...
class GPSLapResult(QMainWindow):
    ...
    def create_map(self):
        """Create the map showing the merged track with start/end markers, GPS marker, and trimmed portion"""
        ...
        try:
            ...
            if not hasattr(self, "route_timestamps") or not self.route_timestamps:
                ...
                if total_points > 0 and total_records > 0:
                    ...
                    route_marker_pos = min(
                        int(self.gps_marker_pos * total_points / total_records),
                        total_points - 1,
                    )
                else:
                    route_trim_start = 0
                ...
                route_marker_pos = self.map_time_to_route_index(self.gps_marker_pos)
